...
{
    internal sealed class CodexGuideConfirmation : EditorWindow
    {
        private string _message;
        private bool _confirmed;
        internal static Action<CodexGuideConfirmation> OpenedForTests;

        internal static bool Confirm(string message)
        {
            CodexGuideConfirmation window = CreateInstance<CodexGuideConfirmation>();
            window._message = message;
            window.titleContent = new GUIContent("Confirm Codex Guide Installation");
        ...
        private void CreateGUI()
        {
            ...
            root.schedule.Execute(() => OpenedForTests?.Invoke(this)).StartingIn(100);
        }
    }
}
